...
with spawner {
	...
	[mumbaShrimp, mumbaShrimp],
	[mumbaShrimp, mumbaCrab],
	[mumbaShrimp, mumbaSquirrel],
	[mumbaShrimp, mumbaRat],
	[mumbaShrimp, mumbaSnowman],
	[mumbaShrimp, mumbaTurtle],
	[mumbaShrimp, mumbaAngel],
	[mumbaShrimp, mumbaFungus],
	[mumbaShrimp, mumbaGhost]
	];

	hardWaves=[
	[mumbaShrimp, mumbaShrimp, mumbaShrimp],
	[mumbaShrimp, mumbaShrimp, mumbaCrab],
	[mumbaShrimp, mumbaShrimp, mumbaSquirrel],
	[mumbaShrimp, mumbaShrimp, mumbaRat],
	[mumbaShrimp, mumbaShrimp, mumbaSnowman],
	[mumbaShrimp, mumbaShrimp, mumbaTurtle],
	[mumbaShrimp, mumbaShrimp, mumbaAngel],
	[mumbaShrimp, mumbaShrimp, mumbaFungus],
	[mumbaShrimp, mumbaShrimp, mumbaGhost],
	[mumbaShrimp, mumbaShrimp, mumbaShrimp, mumbaShrimp],
	[mumbaShrimp, mumbaShrimp, mumbaShrimp, mumbaShrimp]
	]
}
